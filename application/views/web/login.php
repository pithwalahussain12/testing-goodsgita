            ...
            <div class="row">
                <div class="col-lg-6 offset-lg-3">
                    <div class="login-form">
                        <h2>Login</h2>
                         <form id="login_form" name="login_form" action="<?php echo base_url();?>frientend/login" method="post" class="user">
                        ...
                        ?>  
                            <div class="group-input">
                                ...
                                <input type="text" id="userid" name="userid" class="required"  value="<?php if($this->session->flashdata('mobile') != ''){
                 ...
                 <?php echo form_error('userid'); ?>
                            ...
                            <div class="group-input">
                                ...
                                <input type="text" id="password" name="password" class="required" value="<?php if($this->session->flashdata('password') != ''){
