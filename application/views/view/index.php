...
<form role="form" id="add_newspaper_form" name="add_newspaper_form" method="POST" action="<?php echo base_url();?>home/add_productaction/" enctype="multipart/form-data"  class="user">

  <div class="body bg-gray">
      
  <div class="form-group">
    <label class="control-label"> Product Name  </label>
      <input type="text" value="" class="form-control form-control-user required " name="productName"   id="productName" >      
  </div>  
  ...
  <div class="form-group">
    <label class="control-label">  Price  </label>
      <input type="text" value="" class="form-control form-control-user required allownumericwithdecimal" name="price"   id="price" >     
  </div>  

  <div class="form-group">
    <label class="control-label"> Retailprice  </label>
      <input type="text" value="" class="form-control form-control-user required allownumericwithdecimal" name="retailprice"   id="retailprice" >     
  </div>  

  <div class="form-group">
    <label class="control-label"> Whole Sale Price  </label>
      <input type="text" value="" class="form-control form-control-user required allownumericwithdecimal" name="wholesaleprice"   id="wholesaleprice" >     
  </div>    
    
  <div class="form-group">
    <label class="control-label"> Review  </label>
      <input type="text" value="" class="form-control form-control-user required " name="review"   id="review" >      
  </div>  

  <div class="form-group">
    <label class="control-label"> Rating  </label>
      <input type="text" value="" class="form-control form-control-user required " name="rating"   id="rating" >      
  </div>  

  <div class="form-group">
    <label class="control-label"> Availability  </label>
      <input type="text" value="" class="form-control form-control-user required " name="availability"   id="availability" >      
  </div>  
