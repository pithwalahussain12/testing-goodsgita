...
<li><a href="<?php echo base_url();?>koreatown-administrator/AllProductsmerchant">Product</a></li>
...
<form role="form" id="update_category_form" name="update_category_form" method="POST" action="<?php echo base_url();?>koreatown-administrator/update_productmerchant/<?php echo $edit_data->id; ?>" enctype="multipart/form-data" >
<div class="box-body">
	...
	<div class="form-group">
		...
		<input type="text" value="<?php echo $this->session->userdata('admin_name'); ?>" class="form-control required " name="merchantId"   id="merchantId" readonly >	
	</div>	
