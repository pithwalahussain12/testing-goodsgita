...
{          
			$.ajax({
				type: "post",
				url: "<?php echo base_url(); ?>koreatown-administrator/get_users",	
				dataType:"json",
...
<li><a href="<?php echo base_url();?>koreatown-administrator/UserList">Users</a></li>
</ol>
</section>
...
<a href="<?php echo base_url() ?>koreatown-administrator/add_users"><button class="btn btn-primary pull-right" type="button" style="margin-right:10px;"><i class="fa fa-plus"></i> Add Users</button></a>
