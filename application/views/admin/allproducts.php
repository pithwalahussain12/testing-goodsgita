...
{          
			$.ajax({
				type: "post",
				url: "<?php echo base_url(); ?>koreatown-administrator/get_products",	
				dataType:"json",
...
function delete_products(id)
{
	$('#confirm').modal({ backdrop: 'static', keyboard: false })
        .one('click', '#delete', function (e) { 
			...
			location.href ='<?php echo base_url() ?>koreatown-administrator/delete_products/'+id;
...
<li><a href="<?php echo base_url();?>koreatown-administrator/AllProducts">Products</a></li>
</ol>
</section>
...
<a href="<?php echo base_url() ?>koreatown-administrator/add_products"><button class="btn btn-primary pull-right" type="button" style="margin-right:10px;"><i class="fa fa-plus"></i> Add products</button></a>
