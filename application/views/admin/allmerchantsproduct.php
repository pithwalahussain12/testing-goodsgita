...
function getall_productsm()
{          
			$.ajax({
				type: "post",
				url: "<?php echo base_url(); ?>koreatown-administrator/get_productsmerchant",	
				dataType:"json",
...
function delete_productsmerchant(id)
{
	$('#confirm').modal({ backdrop: 'static', keyboard: false })
        .one('click', '#delete', function (e) { 
			
			location.href ='<?php echo base_url() ?>koreatown-administrator/delete_productsmerchant/'+id;
...
<li><a href="<?php echo base_url();?>koreatown-administrator/AllProductsmerchant">Products</a></li>
</ol>
</section>
...
<a href="<?php echo base_url() ?>koreatown-administrator/add_merchantproduct"><button class="btn btn-primary pull-right" type="button" style="margin-right:10px;"><i class="fa fa-plus"></i> Add products</button></a>
