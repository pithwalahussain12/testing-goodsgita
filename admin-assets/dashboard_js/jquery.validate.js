...
$.extend($.validator, {
	...
	messages: {
		...
		multiemails: $.validator.format("You must enter a valid e -mail address.")
	},
	...
	methods: {
		...
		accept: function(value, element, param) {
			param = typeof param === "string" ? param.replace(/,/g, '|') : "png|jpe?g|gif|jpg|bmp|PSD|TIFF";
...
}, jQuery.format("No space please and don't leave it empty.")); 
...
$.validator.addMethod("nonezero", function(value, element) {
    return this.optional(element) || /^[0-9][0-9]*(\.[0-9]+)?|0+\.[0-9]*[0-9][0-9]*$/.test(value);
}, "Please insert zero or greater than zero");
